...
class YtDesktopDrawer extends StatefulWidget {
  YtDesktopDrawer({
    super.key,
  });

  @override
  State<YtDesktopDrawer> createState() => _YtDesktopDrawerState();
}

class _YtDesktopDrawerState extends State<YtDesktopDrawer> {
  @override
